...
export const STEPS_THEME: { [variant: string]: StepsTheme } = {
  default: {
    ...
    step: 'relative flex-1 flex flex-col before:transition-all before:duration-300 transition-all duration-300 items-center before:absolute before:top-4 before:-z-[1] before:-left-1/2 before:h-px',
  ...
  vertical:{
    ...
    headerWrapper: 'min-w-[250px] relative flex flex-col justify-between items-start overflow-hidden',
