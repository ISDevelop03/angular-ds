export const theme = {
  default: {
    ...
    list: {
      ...
      tab: {
        base: 'w-fit text-[14px]/[16px] rounded p-3 font-bold focus:outline-none outline-none text-nowrap focus:border-none focus:ring-none transition-all duration-300 ease-in-out',
  ...
  noBackground: {
    ...
    list: {
      ...
      tab: {
        base: 'w-fit relative text-[14px]/[18px] rounded-t-lg py-2 px-3 font-bold focus:outline-none outline-none text-nowrap focus:border-none focus:ring-none transition-all duration-300 ease-in-out after:absolute after:bottom-0 after:left-1/2 after:-translate-x-1/2 after:w-[18px] after:rounded-t-full after:h-[3px] after:bg-red-500 after:transition-all after:duration-300 after:ease-in-out after:opacity-0 after:content-[""]',
  ...
  withBorder: {
    ...
    list: {
      ...
      tab: {
        base: 'w-fit relative text-[14px]/[18px] rounded py-3 px-3 font-bold focus:outline-none outline-none text-nowrap focus:border-none focus:ring-none transition-all duration-300 ease-in-out after:absolute after:bottom-0 after:left-1/2 after:-translate-x-1/2 after:w-[70%] after:rounded-t-full after:h-[3px] after:bg-red-500 after:transition-all after:duration-300 after:ease-in-out after:opacity-0 after:content-[""]',
        selected: 'bg-level-4 text-neutral-900 after:opacity-100',
        unselected:
