  ...
  default: {
    element: {
      ...
      options: {
        ...
        container:
          'absolute top-0 border border-neutral-100 bottom-0 mb-1 mt-1 max-h-60 overflow-y-auto w-full rounded-lg bg-level-3 py-1 text-[0.75rem] leading-[14px] focus:outline-none border shadow-dropdown2',
        element:
