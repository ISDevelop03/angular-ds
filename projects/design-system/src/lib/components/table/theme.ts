...
export const TableThemes: Record<TableVariant, TableTheme> = {
  default: {
    ...
    headerText: 'inline-flex text-[14px]/[20px]',
    ...
    cell: 'px-4 text-[16px]/normal font-medium py-2',
  },
  striped: {
    table: 'w-full text-left',
    header: 'bg-gray-200',
    headerIcons: 'inline-flex items-center text-gray-500',
    headerText: 'inline-flex text-[14px]/[18px]',

    headerCell: 'px-4 py-1.5 text-sm font-semibold',
    headerTh: 'inline-flex items-center gap-1 text-[14px]/[18px]',
    headerCellButton: 'w-fit',
    headerCellSortable: ' select-none',
    body: '',
  ...
  bordered: {
    ...
    headerTh: 'inline-flex items-center gap-1 text-[14px]/[20px]',
    headerIcons: 'inline-flex items-center text-gray-500',
    headerText: 'inline-flex text-[14px]/[20px]',
