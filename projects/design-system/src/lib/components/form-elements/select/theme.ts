  ...
  default: {
    element: {
      ...
      button: {
        ...
        placeholder: 'font-bold dark:text-white text-[12px]/normal text-neutral-900 mr-1',
      },
      field: {
      ...
      options: {
        ...
        container:
          'absolute left-0 top-0 border border-neutral-100 bottom-0 p-1 mb-1 mt-1 min-w-32 max-h-60 overflow-y-auto w-fit min-w-full rounded-lg bg-level-3 py-1 text-[0.875rem]/[1rem] focus:outline-none border shadow-dropdown2',
        element:
